...
module.exports = {
    forbidden: [
        // SPECIFIC TO migratable-json-document
        {
            name: 'no-external',
            severity: 'error',
            comment: 'This library should have no external runtime dependencies at all.',
            from: {
                path: '[.]ts$',
            },
            to: {
...
// generated: dependency-cruiser@16.10.1 on 2025-04-29T16:39:58.706Z
